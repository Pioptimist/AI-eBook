...
Generate the outline for the book based on the above requirements now.`;
    ...
    const text =  response.text;  //dont use () bcz text() is not a function

    // find and extract the json arrray from the response text
