      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center space-y-4 mb-20">
          <div className="inline-flex items-center space-x-2 bg-violet-100 px-4 py-2 rounded-full">
            <span className="h-2 w-2 bg-purple-600 rounded-full animate-pulse"></span>
            <span className="text-sm text-violet-900 font-semibold">
              Features
            </span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-5xl font-bold tracking-tight text-gray-900 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative  bg-white rounded-2xl p-8 hover:border-violet-200 transition-all duration-300 border border-gray-100 hover:shadow-xl hover:shadow-violet-500/10 hover:translate-y-1"
              >
                ...
                <div className="relative space-y-4">
                  <div
                    className={`w-14 h-14 flex-shrink-0 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <div>
                    ...
                    <div className="pt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <span className="text-sm text-violet-600 font-medium inline-flex items-center">Learn more
                      <svg
        ...
        <div className="text-center mt-16">
          ...
          <a
            href="/signup"
            className="inline-flex items-center px-8 py-4 space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold shadow-lg rounded-xl shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200"
          >
