...
const Testimonials = () => {
  return (
    <div id='testimonials' className="relative py-24 lg:py-32 bg-gradient-to-br from-violet-50 viaa-purple-50 to-white overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-20 rigt-10 w-64 h-64 bg-violet-200/30 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-purple-200/30 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-64 h-64 bg-violet-200/30 rounded-full blur-3xl"></div>
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight">
            Loved by Creators
            <span className="block mt-2 bg-gradient-to-r from-violet-600 to-purple-600 text-transparent bg-clip-text">
              Everywhere
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="group relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 hover:border-violet-200 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-300 hover:-translate-y-2">
              {/* Quote Icon */}
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-violet-50/0 to-purple-60/0  group-hover:from-violet-50/50 group-hover:to-purple-50/30 rounded-3xl transition-all duration-300 -z-10"></div>
