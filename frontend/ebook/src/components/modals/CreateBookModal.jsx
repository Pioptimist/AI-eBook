        ...
        >
            {step === 1 && (
                <div className="space-y-5">
                    <div className="flex items-center mb-6 gap-2">
                        <div className="flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full text-violet-600 text-sm font-semibold">1</div>
                        <div className="flex-1 h-0.5 bg-gray-200"></div>
                        <div className="flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full text-gray-600 text-sm font-semibold">2</div>
                    </div>
            ...
            {step === 2 && (
                <div className="space-y-5">
                    {/* Progress indicator */}
                    <div className="flex items-center mb-6 gap-2">
                        <div className="flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full text-violet-600 text-sm font-semibold">
                            ✓
                        </div>
                        <div className="flex-1 h-0.5 bg-violet-600"></div>
                        <div className="flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full text-gray-600 text-sm font-semibold">
                            2
                        </div>
                    </div>
                            ...
                            chapters.map((chapter, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-3 mb-3">
                                        <div className="flex items-center justify-center w-6 h-6 bg-violet-50 rounded-full text-violet-600 text-xs font-semibold flex-shrink-0 mt-2">
                                            {index + 1}
                                        </div>
                                        <input
                                            type="text"
