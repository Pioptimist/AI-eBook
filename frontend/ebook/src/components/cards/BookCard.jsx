...
const BookCard = ({ book, onDelete }) => {
  ...
  const coverImageUrl = book.coverImage
    ...
    return (
        <div
            className="group relative bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-200 hover:shadow-xl hover:shadow-gray-100/50 hover:-translate-y-1 cursor-pointer"
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                ...
                <div className="relative">
                    <h3 className="font-semibold text-white text-sm leading-tight line-clamp-2 mb-11">{book.title}</h3>
