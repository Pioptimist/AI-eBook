...
if (selectedChapterIndex === null || !book.chapters[selectedChapterIndex]) {   
    // If there’s no valid chapter selected OR the chapter at that index doesn’t exist, then run this code.
  return (
            ...
            <div className="px-8 py-6">
                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-0 justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 md:text-base mt-1">
                    ...
                    <div className="flex items-center gap-3">
                        {/* Editor Controls */}
                        <div className="flex items-center border borde-gray-200 rounded-lg overflow-hidden">
                            <button
                                onClick={() => setIsPreviewMode(false)}
                                className={`px-3 py-2 text-sm font-medium transtion-colors ${!isPreviewMode
