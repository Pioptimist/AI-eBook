...
// the above is important bcz iske bine chapters reorder nhi ho payenge chahe hum usko grab kr lenge 
...
try {
  const response = await axiosInstance.put(
    `${API_PATHS.BOOKS.UPDATE_COVER}/${bookId}/cover`,
    formData,
    {
...
// };
  ...
  };   //important function to turn into pdf and download ask chatgpt to reexplain later
  ...
  return (
    <>
      <div className="flex bg-slate-50 font-sans relative min-h-screen">
        ...
        {isSidebarOpen && (
          <div
            className="fixed inset-0 z-40 flex md:hidden"     //hideen on medium and above devices
            role="dialog"
            aria-modal="true"
          >
            <div
