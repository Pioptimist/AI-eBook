...
export const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Organize all your ebook projects in a personal dashboard. Easily track progress, edit drafts, and manage your collection.",
    icon: Library,
...
export const TESTIMONIALS = [
  ...
  {
    quote: 'The one-click export feature saved me so much time. I was able to publish my ebook on multiple platforms quickly.',
    author: 'Peter Jones',
